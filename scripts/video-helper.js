...
export function selectVideoLink(
  links,
  preferredType,
...
export function createVideoWithPoster(
  linkUrl,
  poster,
  className,
  videoConfig = {}
